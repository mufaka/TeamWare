...
{
    Task<ServiceResult<PagedResult<UserDirectoryEntryViewModel>>> SearchUsers(string? searchTerm, int page = 1, int pageSize = 20);

    Task<ServiceResult<PagedResult<UserDirectoryEntryViewModel>>> GetUsersSorted(string sortBy = "displayname", bool ascending = true, int page = 1, int pageSize = 20);
