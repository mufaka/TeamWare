...
{
    /// <inheritdoc />
    public partial class AddTaskItemAndTaskAssignment : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSomedayMaybe = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_IsNextAction",
                table: "TaskItems",
                column: "IsNextAction");

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_IsSomedayMaybe",
                table: "TaskItems",
                column: "IsSomedayMaybe");
